...
@export var group_name : String = "wander"
...
func start_idle_cycle():
	...
	$idle_stop.start()         # IdleTimer's wait time should be set to 3 seconds
	$Iidle_cycle.start()    # IdleCycleTimer's wait time should be set to a short interval (e.g., 0.5 seconds)
